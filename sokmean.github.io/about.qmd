---
title: "Text Analysis : The shift of the Fedaral Reserve before and after COVID-19 "
---
...
```{r fig.cap = "Shows the most frequently used words in FOMC policy statements after removing common stopwords. Several key economic terms appear prominently, including inflation, economic, rate, and market. This suggests that the statements largely focus on inflation conditions and monetary policy decisions, which are central responsibilities of the Federal Reserve."}
#| echo: false
#| warning: FALSE
#| message: FALSE
#| fig-width: 5
...
```{r fig.cap = "Shows the net expansion vs contraction signal in the FOMC statements by year. Before 2020 ( Pre-Covid), exspansionary langauges increases then drops sharply during COVID shock, which shows more cautious economics communication by the federal reserve."}
#| echo: false
#| results: 'hide'
#| fig-width: 5
#| fig-height: 3
...
```{r fig.cap = "Shows good vs bad economic terms in FOMC statement by year.Positive economic language dominates most years, while negative language increases during the COVID-19 shock (2020–2021), reflecting the economic disruption caused by the pandemic."}
#| echo: false
#| results: 'hide'
 #| fig-width: 5
#| fig-height: 3
